...
product8 = Product.create( name: "Balenciaga Le Cagole XS Shoulder Bag in White", description: "Balenciaga le cagole bag
    ...
    Adjustable strap 18.1 inch", price: "2250", category_id: 2, image: "https://process.fs.grailed.com/AJdAgnqCST4iPtnUxiGtTz/auto_image/cache=expiry:max/rotate=deg:exif/resize=height:700/output=quality:90/compress/pYzrz9WVRwCTfisCvaqI")
product9 = Product.create( name: "Christian Dior By John Galliano S/S 2006 Runway Dress", description: "Christian Dior By John Galliano S/S 2006 Runway Dress
    ...
    Waist : 30 inches
    Hem : 19 inches
    Made in Italy ", price: "5000 ", category_id: 2, image: "https://process.fs.grailed.com/AJdAgnqCST4iPtnUxiGtTz/auto_image/cache=expiry:max/rotate=deg:exif/resize=height:700/output=quality:90/compress/0617ophaSmG8C6RMMTof")
product10 = Product.create( name: "Christian Dior blue Oblique saddle bag", description: "Iconic saddle bag 💼
    Cant go wrong with the oblique pattern", price: "2100", category_id: 2, image: "https://process.fs.grailed.com/AJdAgnqCST4iPtnUxiGtTz/auto_image/cache=expiry:max/rotate=deg:exif/resize=height:700/output=quality:90/compress/9uS1RPPGTjICNxP18w86")
product11= Product.create( name: "COUSSIN PM BAG", price: "7100", category_id: 3, image: "https://process.fs.grailed.com/AJdAgnqCST4iPtnUxiGtTz/auto_image/cache=expiry:max/rotate=deg:exif/resize=height:700/output=quality:90/compress/14rzNqf0QO6LUIMNtiX8")
product12 = Product.create( name: "Pink Sapphire Tiny Cross", description: "Very beautiful piece
    ...
    All sales are final
    No refunds ", price: "2985", category_id: 3, image: "https://process.fs.grailed.com/AJdAgnqCST4iPtnUxiGtTz/auto_image/cache=expiry:max/rotate=deg:exif/resize=height:700/output=quality:90/compress/Iy6O5U40SrWXb8qhxiY3")
product13 = Product.create( name: "Iced out BAPE/Kid Cudi G shock", description: "Cuatom G shock kid cudi/ Bape edition
    ...
    real diamonds
     ...
     ", price: "12000 ", category_id: 3, image: " https://process.fs.grailed.com/AJdAgnqCST4iPtnUxiGtTz/auto_image/cache=expiry:max/rotate=deg:exif/resize=height:700/output=quality:90/compress/NSrtOeVSAqJGnmy66pAw")
product14 = Product.create( name: "Alabaster Industries Silver Wood Grain Watch", description: "1 of 1 very rare alabaster industries watch.
    ...
    in mint condition including original box and receipt ", price: " 4200", category_id: 3, image: " https://process.fs.grailed.com/AJdAgnqCST4iPtnUxiGtTz/auto_image/cache=expiry:max/rotate=deg:exif/resize=height:700/output=quality:90/compress/YR3T203SR1qE65g3gfwD")
product15 = Product.create( name: "CHROME HEARTS STERLING SILVER CROSS CLUSTER CUFF EARRING", description: " CHROME HEARTS STERLING SILVER CROSS CLUSTER CUFF EARRING
    ...
    TO BE WORN ON THE RIGHT EAR", price: "1350 ", category_id: 3, image: " https://process.fs.grailed.com/AJdAgnqCST4iPtnUxiGtTz/auto_image/cache=expiry:max/rotate=deg:exif/resize=height:700/output=quality:90/compress/koNRZGeuSOWNaG2lZ0As")
